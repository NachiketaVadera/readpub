...
The package lives at the repository root and requires Dart 3.13 or later.
It runs on Dart VM and Flutter host runtimes without Flutter, FFI, or native bindings.
...
[performance](docs/PERFORMANCE.md) and [dependencies](docs/DEPENDENCIES.md).
